...
it's helpful because it lets you acess a match without a rendering a route by providing access to the match object.

2. How would you explain form validation to someone who has never programmed before?

I would tell them that it is about having a successful submission, where data is being collected and passed to the end user. Form validations can be for submitting information, log ins, and create accounts,etc.

3. In 1-2 sentences, define end to end testing.
With the use of Cypress.io, you are able to test the end user experience by being able to test thing like submission form, selecting options, and adding text to a box.
